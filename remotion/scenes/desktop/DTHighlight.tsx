...
export const DTHighlight: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      <HeroBackdrop
        src="images/landscape/highlight.png"
        zoomFrom={1.04}
        zoomTo={1.12}
        panX={10}
        panY={-5}
      ...
      <AbsoluteFill
        style={{
          background:
            'linear-gradient(90deg, rgba(7, 11, 23, 0.78) 0%, rgba(7, 11, 23, 0.4) 35%, rgba(7, 11, 23, 0.0) 55%)',
          pointerEvents: 'none',
        }}
      />
        ...
        >
          ...
          <div
            style={{
              ...
              letterSpacing: -3.5,
              color: theme.text,
              textShadow: `0 4px 30px rgba(0,0,0,0.85), 0 0 ${50 + pulse * 60}px ${theme.glowGreen}, 0 0 30px ${theme.glow}`,
            }}
          >
            No bias.
            <br />
